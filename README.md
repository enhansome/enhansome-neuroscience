...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,125 | 🐛 106 | 📅 2026-09-02
...
* [DeepLabCut](https://github.com/DeepLabCut/DeepLabCut) ⭐ 5,765 | 🐛 49 | 🌐 Python | 📅 2026-09-11 - Markerless pose estimation toolkit for animal behavior analysis using transfer learning with deep neural networks.
* [MNE-Python](https://github.com/mne-tools/mne-python) ⭐ 3,511 | 🐛 616 | 🌐 Python | 📅 2026-09-11 - Community-driven software for processing time-resolved neural signals including electroencephalography (EEG) and magnetoencephalography (MEG).
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,073 | 🐛 174 | 🌐 Python | 📅 2026-09-11 - Package for running psychology and neuroscience experiments. It allows for creating psychology stimuli in Python.
* [Nilearn](https://github.com/nilearn/nilearn) ⭐ 1,431 | 🐛 288 | 🌐 Python | 📅 2026-09-11 - Module for performing statistical learning/machine learning on NeuroImaging data.
* [Brian2](https://github.com/brian-team/brian2) ⭐ 1,228 | 🐛 209 | 🌐 Python | 📅 2026-09-03 - Free, open source simulator for spiking neural networks.
* [Nengo](https://github.com/nengo/nengo) ⭐ 947 | 🐛 140 | 🌐 Python | 📅 2026-08-02 - Library for creating and simulating large-scale brain models.
* [SpikeInterface](https://github.com/SpikeInterface/spikeinterface) ⭐ 846 | 🐛 335 | 🌐 Python | 📅 2026-09-11 - Framework designed to unify spike-sorting technologies
* [DIPY](https://github.com/nipy/dipy) ⭐ 838 | 🐛 122 | 🌐 Python | 📅 2026-09-11 - Toolbox for analysis of MR diffusion imaging.
...
* [NiBabel](https://github.com/nipy/nibabel) ⭐ 791 | 🐛 161 | 🌐 Python | 📅 2026-09-07 - Provides read and write access to some common medical and neuroimaging file formats.
* [fMRIPrep](https://github.com/nipreps/fmriprep) ⭐ 751 | 🐛 342 | 🌐 HTML | 📅 2026-09-11 - Robust preprocessing pipeline for fMRI data that adapts to nearly any dataset and produces analysis-ready outputs with minimal manual intervention.
...
* [Monty](https://github.com/thousandbrainsproject/tbp.monty) ⭐ 585 | 🐛 79 | 🌐 Python | 📅 2026-09-11 - Sensorimotor learning framework based on the thousand brains theory of the neocortex.
* [NEURON](https://github.com/neuronsimulator/nrn) ⭐ 541 | 🐛 474 | 🌐 C++ | 📅 2026-09-11 - Simulation environment for modeling individual neurons and networks of neurons, widely used in computational and systems neuroscience.
* [Suite2p](https://github.com/MouseLand/suite2p) ⭐ 473 | 🐛 65 | 🌐 Python | 📅 2026-09-07 - Pipeline for cell detection and signal extraction from large-scale two-photon calcium imaging recordings.
...
* [BindsNET](https://github.com/Hananel-Hazan/bindsnet) ⭐ 0 | 🐛 0 | 📅 2026-09-09 - Package for simulating spiking neural networks for reinforcement & machine learning.
* [NiMARE](https://nimare.readthedocs.io/en/latest/) - NiMARE is a Python package for neuroimaging meta-analyses

### Matlab

* [FieldTrip](https://github.com/fieldtrip/fieldtrip) ⭐ 987 | 🐛 107 | 🌐 MATLAB | 📅 2026-09-11 - Toolbox for MEG and EEG analysis.
...
* [Brainbrowser](https://github.com/aces/brainbrowser) ⭐ 398 | 🐛 40 | 🌐 JavaScript | 📅 2025-11-18 - Library exposing set of web-based 3D visualization tools primarily targetting neuroimaging.
...
* [Neuromatch Academy](https://github.com/NeuromatchAcademy/course-content) ⭐ 3,126 | 🐛 33 | 🌐 Jupyter Notebook | 📅 2026-07-14 - Jupyter notebooks for the three-week intensive summer school in computational neuroscience.
...
* [Awesome Public Datasets - Neuroscience](https://github.com/awesomedata/awesome-public-datasets#neuroscience) ⭐ 78,917 | 🐛 159 | 📅 2026-09-11 - High-quality open neuroscience datasets.
